...
#' @param control This is the control that will be used in the rpart() function.
#' The user has 3 options, one of which is the default selected control by the rpart() function. The remaining two option are:
